...
#### Ασκήσεις
Στο τέλος κάθε διάλεξης θα ανεβαίνουν εδώ 7-10 ασκήσεις σχετικά με την ύλη που παρουσιάστηκε στη διάλεξη. 
...
* Ασκήσεις  1-20 : θα ανακοινωθεί αργότερα 
...
### Projects
Το περιεχόμενο, η δομή και ο τρόπος εξέτασης των projects θα ανακοινωθεί αργότερα.

Ημερομηνία παράδοσης των projects είναι: (**θα ανακοινωθεί αργότερα**). 
