...
### Άσκηση 11
Φτιάξτε μία συνάρτηση η οποία θα παίρνει σαν παράμετρο μία λίστα από strings με μικρά λατινικά γράμματα (δεν χρειάζεται να το ελέγξετε αυτό). Η συνάρτηση θα επιτρέφει μία νέα λίστα με όλα τα strings της παραμέτρου τα οποία ξεκινάνε με φωνήεν ('a', 'e', 'i', 'o', 'u', 'y'). Για παράδειγμα θα πρέπει:
...
### Άσκηση 12
Φτιάξτε μία συνάρτηση η οποία θα παίρνει μία λίστα η οποία αποτελείται από υπο-λίστες με ακέραιους αριθμούς (δεν χρειάζεται να το ελέγξετε αυτό). Η συνάρτηση θα επιστρέφει μία νέα λίστα με τα στοιχεία της λίστας της παραμέτρου των οποίων το άθροισμα είναι άρτιος (ζυγός). Για παράδειγμα θα πρέπει:
...
### Άσκηση 15
Φτιάξτε μία συνάρτηση η οποία θα παίρνει σαν παράμετρο μία λίστα. Η λίστα θα περιέχει υπο-λίστες με 3 στοιχία. Το πρώτο θα είναι ένα όνομα (string) ενός μαθητή, το 2o θα είναι η ηλικία του/της (ακέραιο) και το 3ο θα είναι ο βαθμός (ακέραιος). Η συνάρτηση θα πρέπει να επιστρέφει ένα string το οποίο θα είναι το όνομα του μαθητή με τη μεγαλύτερη βαθμολογία. Αν δυο ή παραπάνω μαθητές έχουν την ίδια μεγαλύτερη βαθμολογία, τότε επιστρέφει το όνομα του μικρότερου από αυτούς. Για παράδειγμα:
...
Φτιάξτε μία συνάρτηση η οποία θα παίρνει σαν όρισμα μία λίστα η οποία θα έχει την ίδια δομή με τη λίστα `cities`. Η συνάρτηση θα επιστρέφει το όνομα της πόλης η οποία σημείωση τη μεγαλύτερη αύξηση πληθυσμού από το 1991 μέχρι το 2011. Δηλαδή θα πρέπει:
